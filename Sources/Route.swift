...
public func => <S, E: EventType>(leftStates: [S], right: State<S>) -> Route<S, E>
{
...
public func => <S, E: EventType>(leftStates: [S], right: S) -> Route<S, E>
{
    return leftStates => .some(right)
}

/// e.g. .state0 => [.state1, .state], allowing [0 => 1, 0 => 2]
public func => <S, E: EventType>(left: State<S>, rightStates: [S]) -> Route<S, E>
{
...
public func => <S, E: EventType>(left: S, rightStates: [S]) -> Route<S, E>
{
    return .some(left) => rightStates
}

/// e.g. [.state0, .state1] => [.state, .state3], allowing [0 => 2, 0 => 3, 1 => 2, 1 => 3]
public func => <S, E: EventType>(leftStates: [S], rightStates: [S]) -> Route<S, E>
{
